...
### 🖨️ Εκτύπωση
- **Αυτόματη εκτύπωση** κατά την υποβολή παραγγελίας
- **Manual εκτύπωση** από τον διαχειριστή
- **Ελληνικοί χαρακτήρες** υποστηρίζονται (Code Page PC737)

**Αν οι ελληνικοί δεν φαίνονται σωστά:**
- Δοκίμασε να αλλάξεις το code page σε 21 (ISO8859-7) στο `server.js` και `local-printer-agent.js`
- Βρες τις ρυθμίσεις του εκτυπωτή σου για Greek character set

### 🔄 Updates
- **Αυτόματα updates** με `START-AGENT-AUTOUPDATE.bat`
- **Manual updates** με `git pull`
